                        ...
                        <form action="editchapter?chapterid=${chapterid}&bookID=${bookID}" method="post" onsubmit="return validateForm()">
                            <div class="row gy-4">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-12" >
                                        Nội dung
                                        <textarea class="form-control" name="content" id="content" rows="10" minlength="100" maxlength="6000" required>${chapternumber.content_1}  ${chapternumber.content_2}</textarea>
                                    ...
                                    <div class="col-md-12 text-center">
                                        <button type="submit"style="background-color: #4154f1; color: #fff;
                                                padding: 10px 20px 10px 20px; border: none; border-radius: 5px" >Lưu và chỉnh sửa</button>
                                        <a href="listchapter?bookID=${bookID}">
                                            <button type="button"  style="background-color: #4154f1; color: #fff;
